...
class UserManager__Settings(object):
    ...
    .. code-block:: none
        ...
        Feature settings
    """
#    # Current Academic Year, this will be initialied based on app_config.py
    ...
    #: | Show 'Email already exist as alternate email'.
    #: | Depends on USER_ENABLE_EMAIL=True.
    USER_EMAIL_ALREADY_EXIST_AS_ALTERNATE_EMAIL = True
