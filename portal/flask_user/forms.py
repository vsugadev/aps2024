...
def unique_email_validator(form, field):
    ...
    if user_manager.USER_EMAIL_ALREADY_EXIST_AS_ALTERNATE_EMAIL :
        if not user_manager.alternate_email_is_available(field.data):
            raise ValidationError(_('Already registered, this Email is already in use as alternate email. Please try login using your primary email.'))
